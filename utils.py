...
def create_datasets(args):
    ...
    if 'Set5' in args.eval_sets:
        set5_hr_path = os.path.join(args.data_path, 'test/Set5/HR')
        set5_lr_path = os.path.join(args.data_path, 'test/Set5/LR_bicubic')
    ...
    if 'Set14' in args.eval_sets:
        set14_hr_path = os.path.join(args.data_path, 'test/Set14/HR')
        set14_lr_path = os.path.join(args.data_path, 'test/Set14/LR_bicubic')
    ...
    if 'B100' in args.eval_sets:
        b100_hr_path = os.path.join(args.data_path, 'test/BSDS100/HR')
        b100_lr_path = os.path.join(args.data_path, 'test/BSDS100/LR_bicubic')
    ...
    if 'Urban100' in args.eval_sets:
        u100_hr_path = os.path.join(args.data_path, 'test/Urban100/HR')
        u100_lr_path = os.path.join(args.data_path, 'test/Urban100/LR_bicubic')
    ...
    if 'Manga109' in args.eval_sets:
        manga_hr_path = os.path.join(args.data_path, 'test/Manga109/HR')
        manga_lr_path = os.path.join(args.data_path, 'test/Manga109/LR_bicubic')
